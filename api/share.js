// api/share.js - v3.3: 6 images fixes depuis assets/gallery (GitHub)
export default async function handler(req, res) {
  ...
  // ============================================
  // 6 IMAGES FIXES DEPUIS GITHUB assets/gallery
  // ============================================
  const SITE = 'https://www.iapixora.com';
  const FIXED_IMAGES = [
    `${SITE}/assets/gallery/sample-01.jpg`,
    `${SITE}/assets/gallery/sample-02.jpg`,
    `${SITE}/assets/gallery/sample-03.jpg`,
    `${SITE}/assets/gallery/sample-04.jpg`,
    `${SITE}/assets/gallery/sample-05.jpg`,
    `${SITE}/assets/gallery/sample-06.jpg`  ];

  // Exclure l'image actuelle si elle est dans la liste
  const recentImages = FIXED_IMAGES.filter(url => url !== imgUrl).slice(0, 6);
  ...
  const t = {
    fr: {
      ...
      more_title: 'Dernières créations de la communauté',
      more_sub: 'Découvre les images générées par nos utilisateurs',
    ...
    en: {
      ...
      btn_gallery: 'Explore gallery',      btn_shop: 'Shop',
      btn_earn: 'Earn points',
      badge: 'Generated for free on IA Pixora',
      error: 'Image not available',
      more_title: 'Latest community creations',
      more_sub: 'Discover images generated by our users',
  ...
  const recentCards = recentImages.map((imgUrlFixed, i) => {
    const shareLink = `${SITE}/api/share?img=${encodeURIComponent(imgUrlFixed)}&lang=${lang}`;
    return `<a href="${shareLink}" class="recent-card">
      <img src="${imgUrlFixed}" alt="AI Creation ${i+1}" loading="lazy">
    </a>`;
  }).join('\n                ');
...
<head>
    ...
    <meta name="twitter:image" content="${ogUrl}">    <link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .recent-card:hover{border-color:var(--prim);transform:scale(1.03);box-shadow:0 8px 24px rgba(139,92,246,0.2)}        .recent-card img{width:100%;height:100%;object-fit:cover}
