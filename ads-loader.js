// ads-loader.js v36.3 — CORRECTION: Pub milieu = même format que pub haut
(function() {
    'use strict';
    ...
    style.textContent = '.pxr-wrapper{width:100% !important;max-width:100% !important;box-sizing:border-box;margin:1rem 0;border:2px dashed #8B5CF6;padding:0.8rem;background:rgba(139,92,246,0.1);border-radius:12px;text-align:center;max-height:400px;overflow:hidden;display:block;clear:both}.pxr-ad-box{max-height:280px;overflow:hidden;margin-bottom:0.5rem;width:100%}.pxr-ad-box img{max-width:100%;max-height:250px;object-fit:contain;width:100%}.pxr-label{font-size:0.7rem;color:#8B5CF6;margin-bottom:0.5rem;font-weight:700}.pxr-btn-box{margin-top:0.5rem;padding-top:0.5rem;border-top:1px solid rgba(139,92,246,0.2)}.pxr-rw-btn{background:linear-gradient(135deg,#F59E0B,#EF4444);color:white;border:none;padding:0.6rem 1.2rem;border-radius:8px;font-weight:600;cursor:pointer;font-size:0.85rem;display:inline-flex;align-items:center;gap:0.4rem}.pxr-rw-btn:hover{transform:translateY(-2px);box-shadow:0 4px 15px rgba(245,158,11,0.4)}' +
    ...
    async function loadAndInjectAds() {
        ...
        try {
            ...
            // ✅ MIDDLE : Insérer avant "Créations de référence" avec largeur 100%
            var refCreations = main.querySelector('#ref-creations') || 
                               ...
                               Array.from(main.querySelectorAll('h2, h3')).find(function(el) { 
