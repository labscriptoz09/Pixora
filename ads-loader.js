...
(function() {
    ...
    function createRewardedModal() {
        ...
        overlay.innerHTML = '<div class="pxr-rw-modal"><div class="pxr-rw-header"><div class="pxr-rw-title"><i class="fas fa-gift"></i> Pub Récompensée</div><button class="pxr-rw-close" id="pxr-rw-close-btn"><i class="fas fa-times"></i></button></div><div class="pxr-rw-body" id="pxr-rw-body-content"><div class="pxr-rw-reward"><i class="fas fa-bolt"></i> <span id="pxr-rw-points">1</span> points</div><div class="pxr-rw-info">Regarde cette annonce pendant <span id="pxr-rw-timer-val">20</span>s pour gagner des points.</div><iframe id="pxr-rw-iframe" class="pxr-rw-iframe" sandbox="allow-scripts allow-same-origin allow-popups"></iframe><div class="pxr-rw-timer" id="pxr-rw-timer-display">20s</div><button id="pxr-rw-claim-btn" class="pxr-rw-btn-claim" disabled><i class="fas fa-clock"></i> Patientez...</button><div class="pxr-rw-limit" id="pxr-rw-limit-info"></div><div class="pxr-rw-error" id="pxr-rw-error" style="display:none"></div></div></div>';
