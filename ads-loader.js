...
// ✅ CORRECTION : Pub milieu entre "Your Creations" et "Créations de référence" + CSS FIX
(function() {
    'use strict';
    ...
    async function loadAndInjectAds() {
        ...
        try {
            ...
            // ✅ MIDDLE : ENTRE "Your Creations" ET "Créations de référence" — INSÉRÉ DANS MAIN DIRECTEMENT
            ...
            if (refCreations && main.contains(refCreations)) {
                // Insère la pub JUSTE AVANT "Créations de référence" dans le main
